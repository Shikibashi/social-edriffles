/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=deploy/radlib-edge-proxy/wrangler.jsonc deploy/radlib-edge-proxy/worker-configuration.d.ts` (hash: a458c3341aee587ab9f2dc7f2cf2221c)
