/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=deploy/radlib-edge-proxy/wrangler.jsonc deploy/radlib-edge-proxy/worker-configuration.d.ts` (hash: 8292c15191e591e1bf064134da1c249d)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WEB_ORIGIN" | "PDS_ORIGIN" | "PUBLIC_HOST">> {}
}
