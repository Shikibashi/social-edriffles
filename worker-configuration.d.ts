/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=deploy/radlib-edge-proxy/wrangler.jsonc` (hash: e6fcf871c3c02ef48f52526300cae3ab)
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./deploy/radlib-edge-proxy/src/index");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WEB_ORIGIN" | "PDS_ORIGIN" | "APPVIEW_ORIGIN" | "PUBLIC_HOST" | "PDS_PUBLIC_HOST">> {}
}
