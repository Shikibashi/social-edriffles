...
|---|---|---|---|---|
| bluesky-social/social-app | `upstream/social-app` | current upstream `main` merged into fork + radical-liberal branch + opt-in Spaces adapter | `fa14f7e4` | `https://github.com/Shikibashi/social-app` |
