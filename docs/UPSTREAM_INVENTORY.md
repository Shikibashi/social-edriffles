...
|---|---|---|---|---|
| bluesky-social/social-app | `upstream/social-app` | direct fork | `3dff4b0d` | `https://github.com/bluesky-social/social-app` |
| bluesky-social/atproto PDS | `upstream/atproto-pds` | direct fork | `c1a8b80f` | `https://github.com/bluesky-social/atproto` |
