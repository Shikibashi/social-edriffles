...
|---|---|---|---|---|
| bluesky-social/social-app | `upstream/social-app` | merged fork main + radical-liberal branch | `6cca7f1f` | `https://github.com/Shikibashi/social-app` |
| bluesky-social/atproto PDS | `upstream/atproto-pds` | governed fork | `2f40ca1b` | `https://github.com/Shikibashi/atproto` |
