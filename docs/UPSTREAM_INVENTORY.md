...
|---|---|---|---|---|
| bluesky-social/social-app | `upstream/social-app` | merged fork main + radical-liberal branch + opt-in Spaces adapter | `d3ab5f81` | `https://github.com/Shikibashi/social-app` |
| bluesky-social/atproto PDS | `upstream/atproto-pds` | `permissioned-data` base + Spaces product integration | `37f823c7` | `https://github.com/Shikibashi/atproto` |
