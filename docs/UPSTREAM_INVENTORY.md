...
|---|---|---|---|---|
| bluesky-social/social-app | `upstream/social-app` | merged fork main + radical-liberal branch + opt-in Spaces adapter | `5a86dcd9` | `https://github.com/Shikibashi/social-app` |
| bluesky-social/atproto PDS | `upstream/atproto-pds` | `permissioned-data` base + Spaces product integration | `5f413a8e` | `https://github.com/Shikibashi/atproto` |
